...
--
-- Host: localhost    Database: LaravelLinktree
-- ------------------------------------------------------
...
INSERT INTO `links` VALUES (1,1,1,'0','GitHub','https://github.com/lucascignacio','#000000','#521881','rounded'),(2,1,1,'1','Instagram','https://www.instagram.com/lucascignacio/','#000000','#521881','rounded');
...
INSERT INTO `migrations` VALUES (1,'2019_12_14_000001_create_personal_access_tokens_table',1),(2,'2022_10_14_021441_create_all_tables',1);
...
INSERT INTO `pages` VALUES (1,4,'negao','#FFFFFF','color','#73648A,#3F3249','eu.jpeg','Lucas Ignacio','My Linktree','12345');
...
INSERT INTO `users` VALUES (2,'suporte@mail.com','$2y$10$Vesnt3gzi.ZVKNMz6oqyYuFvlpzjpKbniEwzyFpxthpv3xKNlNaci'),(3,'paulo@teste.com','$2y$10$QTcMWfAjj2/z5jNPygtzEelf/t2kI7YMpTHr9dK7qJDNPhxVuKCGe'),(4,'negao@suporte.com','$2y$10$kCjHsG82vYfma8Ip8pePeeTmXxhha/OONgHTueZhvKpKeuQEH7Hw6');
...
INSERT INTO `views` VALUES (1,1,'2022-10-14',40),(2,1,'2022-10-15',10),(3,1,'2022-10-16',318);
...
-- Dump completed on 2022-10-17 18:46:34
